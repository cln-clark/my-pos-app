...
#[sea_orm(table_name = "CRR_TXN_DTL")]
pub struct Model {
    #[sea_orm(primary_key)]
    pub id: i32,
...
pub enum Relation {
    #[sea_orm(
        belongs_to = "super::crr_txn_head::Entity",
        from = "Column::CompanyCode",
        to = "super::crr_txn_head::Column::CompanyCode"
    )]
    CrrTxnHdr,
    #[sea_orm(
...
impl Related<super::crr_txn_head::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::CrrTxnHdr.def()
    }
}
